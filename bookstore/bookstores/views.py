...
def detail(request,books_id):
	...
	#使用模板
	return render(request, 'bookstores/detail.html', context)
...
def list(request,type_id,page):
	...
	#使用模板
	return render(request,'bookstores/list.html',context)
